...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/curlify-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11626&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/curlify-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `curlify` can be installed with:

```
conda install curlify
```

It is possible to list all of the versions of `curlify` available on your platform with:
